...
Performing rarefaction based on the region with less citations. This is used to control for the different number of workds citing each single author papers from different regions
```{r}
