...
plot_cit_geoMark <- plot_grid(plot_all, map_markers_wb, nrow = 2)
...
ggplot2::ggsave(filename = here::here("output", "Fig1_cit_geoMark.png"), plot = plot_cit_geoMark, device = "png", dpi = 300, width = 10, height = 10)
