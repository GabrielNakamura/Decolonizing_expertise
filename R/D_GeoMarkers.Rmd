...
zoo_africa <- lapply(toupper(zoogeo), function(x) grep(x, M_Africa$TI, fixed = T))
...
zoo_NAfrica <- lapply(toupper(zoogeo), function(x) grep(x, M_NAfrica$TI, fixed = T))
...
df_zoo_count <- 
  rbind(count_zoo_africa, count_zoo_ea, count_zoo_eu, count_zoo_la, count_zoo_NAfrica, count_zoo_sa, count_zoo_us)
